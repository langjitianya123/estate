...
class Query
{
     ...
     * @return float|int
     */
    public function sum($field,$default=0,$force=true)
    {
        return $this->value('SUM(' . $field . ') AS tp_sum', $default, $force);
    }
     ...
     * @return mixed
     */
    public function min($field,$default=0,$force=true)
    {
        return $this->value('MIN(' . $field . ') AS tp_min', $default, $force);
    }
     ...
     * @return mixed
     */
    public function max($field,$default=0,$force=true)
    {
        return $this->value('MAX(' . $field . ') AS tp_max', $default, $force);
    }
     ...
     * @return float|int
     */
    public function avg($field,$default=0,$force=true)
    {
        return $this->value('AVG(' . $field . ') AS tp_avg', $default, $force);
    }
